class Practical9
{
      ...
      static void getPerformanceFact1(int number)
      {
	...
	static long Start=0,End=0;
      static int getPerformanceFact2(int number)
      {
             if (number < 0) 
             { 
                  return 0;
            ...
            int factorial = 2;
            Start+=System.nanoTime();
            factorial = number * getPerformanceFact2(number-1);
            End+=System.nanoTime();
      ...
      static void getPerformanceString(int size)
      {
            long Start=0,End=0;
            String test="";
      ...
      static void getPerformanceStringBuffer(int size)
      {
            long Start=0,End=0;
      ...
      static void getPerformanceStringBuilder(int size)
      {
            long Start=0,End=0;
      ...
      public static void main(String[] args)
      {
            ...
            getPerformanceFact1(Integer.parseInt(args[0]));
            getPerformanceFact2(Integer.parseInt(args[0]));
            getPerformanceString(Integer.parseInt(args[0]));
            getPerformanceStringBuffer(Integer.parseInt(args[0]));
            getPerformanceStringBuilder(Integer.parseInt(args[0]));
